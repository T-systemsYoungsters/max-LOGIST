...
def cloud(screen,x,y):
    ...
    pygame.draw.circle(screen, (226,0,116), (40+x, -20+y), 25)
    pygame.draw.circle(screen, (226,0,116), (70+x, -10+y), 25)
background_image = pygame.image.load((r"C:\Users\A200162668\Desktop\Hauptordner\Python\.vscode\pythonlernen\pythonbetrieb\lab\graphicsandusercontrol\background.jpg")).convert()
pygame.mouse.set_visible(0)
click_sound = pygame.mixer.Sound((r"C:\Users\A200162668\Desktop\Hauptordner\Python\.vscode\pythonlernen\pythonbetrieb\lab\graphicsandusercontrol\laser5.ogg"))
while done==False:
